...
public class PersonA : Talktome
{
    ...
    void Start()
    {
        ...
        Dialogbox.Dialogstate ds0 = new Dialogbox.Dialogstate { Title = "Random Asshat", Message = "Why don't you smile some more`?", optionA = "*smile*", optionB = "Fuck off!", oA_changeval = 100f, oB_changeval = 0f, end = false };
